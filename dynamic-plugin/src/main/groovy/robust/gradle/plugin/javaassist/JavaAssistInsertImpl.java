...
//                        System.out.println("ClassPool "+classPool.toString());

                        CtClass type = classPool.getOrNull(Constants.INTERFACE_NAME);

                        System.out.println("CtClass type "+type);
